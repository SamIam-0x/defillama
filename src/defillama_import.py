...
# Ask user whether to fetch new data or use existing data
print("=" * 60)
print("DeFiLlama Data Import Options")
print("=" * 60)
print("1. Fetch fresh data from APIs (takes ~5-10 minutes)")
print("2. Use existing data files (skip API calls)")
print("=" * 60)
...
if fetch_new_data:
    ...
    required_files = [
        'all_stablecoins_chain_distribution.csv',
        'meta_stablecoins_chain_distribution.csv',
        'chain_tvl_data.csv'
    ]
    ...
    if missing_files:
        ...
        print("Please run option 1 (fetch fresh data) first to create these files.")
        exit(1)
    else:
        print("✅ All required data files found.")
        print("🚀 Running analysis with existing data...")
